...
public sealed class UpdateLandingPageTemplateCommandValidator : AbstractValidator<UpdateLandingPageTemplateCommand>
{
    public UpdateLandingPageTemplateCommandValidator()
    {
