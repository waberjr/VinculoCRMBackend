using VinculoBackend.Domain.Events;
using Microsoft.Extensions.Logging;

namespace VinculoBackend.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("VinculoBackend Domain Event: {DomainEvent}", notification.GetType().Name);
