...
public static class SystemOptionMapper
{
        ...
        where TEnum : struct, Enum
    {
        ...
        throw new Common.Exceptions.ValidationException(
            [
                new FluentValidation.Results.ValidationFailure(typeof(TEnum).Name, $"Valor inválido: {value}.")
            ]);
    }
        ...
        where TEnum : struct, Enum
    {
        return value switch
        {
            DonorPersonType.Individual => new("Pessoa física", 1),
            DonorPersonType.Company => new("Pessoa jurídica", 2),
            ...
            DonorStatus.DoNotContact => new("Não contatar", 5, "red"),
            ...
            PaymentMethod.CreditCard => new("Cartão de crédito", 3),
            PaymentMethod.BankTransfer => new("Transferência bancária", 4),
            ...
            CampaignType.Fundraising => new("Captação", 1),
            CampaignType.Retention => new("Retenção", 2),
            CampaignType.Reactivation => new("Reativação", 3),
            ...
            CampaignStatus.Completed => new("Concluída", 3),
            CampaignStatus.Cancelled => new("Cancelada", 4),
            ProjectStatus.Draft => new("Rascunho", 1),
            ProjectStatus.Active => new("Ativo", 2, "green"),
            ProjectStatus.Completed => new("Concluido", 3, "blue"),
            ProjectStatus.Archived => new("Arquivado", 4),
            ...
            TaskType.DataUpdate => new("Atualização cadastral", 7),
            TaskType.Other => new("Outra", 8),
            TaskPriority.Low => new("Baixa", 1),
            TaskPriority.Medium => new("Média", 2),
            ...
            RelationshipTaskStatus.Completed => new("Concluída", 3, "green"),
            RelationshipTaskStatus.Cancelled => new("Cancelada", 4),
            ContactOutcome.Reached => new("Contato realizado", 1),
            ContactOutcome.NoAnswer => new("Não atendeu", 2),
            ContactOutcome.InvalidContact => new("Contato inválido", 3),
            ContactOutcome.RequestedCallback => new("Retorno solicitado", 4),
            ContactOutcome.DonationConfirmed => new("Doação confirmada", 5),
            ContactOutcome.NotInterested => new("Sem interesse", 6),
            ContactOutcome.DoNotContact => new("Não contatar", 7),
            ContactOutcome.Other => new("Outro", 8),
            TimelineEntryType.Note => new("Nota", 1),
            TimelineEntryType.Donation => new("Contribuição", 2, "green"),
            ...
            EmailType.Billing => new("Cobrança", 3),
